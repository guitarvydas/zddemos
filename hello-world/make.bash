...
python3 main.py . - '' nondeterministic hello-world.json | jq -M --compact-output .
python3 main.py . - '' seq1 hello-world.json | jq -M --compact-output .
python3 main.py . - '' seq2 hello-world.json | jq -M --compact-output .
